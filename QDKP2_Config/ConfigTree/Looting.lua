...
local function GetItemCustomP(info)
    local v = GetItemVoice(info)
    if not v.price or v.price == 0 then
        return ''
    else
        return v.price
    end
...
local ItemVoice = {
    ...
    args = {
        ...
        LOOT_Item_SelectP = {
            ...
            get = GetItemSelectP,
            set = SetItemSelectP,
            values = { L.LOOT_Item_Select1, L.LOOT_Item_Select2, L.LOOT_Item_Select3 },
            order = 30,
        },
        LOOT_Item_CustomP = {
            type = 'input',
            disabled = function(info)
                if GetItemSelectP(info) ~= 2 then
                    return true;
                end ;
            end,
            pattern = '^-?%d+$',
        ...
        LOOT_Item_NotifyLoot = {
            ...
            set = SetNotifyLoot,
            order = 50,
            values = { L.LOOT_Item_NotifyLoot1, L.LOOT_Item_NotifyLoot2, L.LOOT_Item_NotifyLoot3, L.LOOT_Item_NotifyLoot4, L.LOOT_Item_NotifyLoot5 },
        },
