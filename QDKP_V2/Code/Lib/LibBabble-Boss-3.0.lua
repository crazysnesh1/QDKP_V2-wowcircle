...
local MINOR_VERSION = 90001 + tonumber(("$Rev: 304 $"):match("%d+"))
...
elseif GAME_LOCALE == "frFR" then
	...
	["Thane Korth'azz"] = "Thane Korth'azz",
	["The Beast"] = "La Bête",
	["Northrend Beasts"] = "Les bêtes du Norfendre",
...
elseif GAME_LOCALE == "esES" then
	...
	["Thane Korth'azz"] = "Thane Korth'azz",
	["The Beast"] = "La Bestia",
	["Northrend Beasts"] = "Las bestias de Rasganorte",
...
elseif GAME_LOCALE == "ruRU" then
	...
	Hakkar = "Хаккар",
	Halazzi = "Халаззи",
	Halion = "Халион Сумеречный Разрушитель",
	Halycon = "Халикон",
	Hamhock = "Хрупконог",
