...
function GuildExport:GetMembers()
    return QDKP2name;
end
...
GuildExport.Columns = {
    ...
    },
    {
        ...
        isDisabled = function(name, Format)
            if Format == "xml" then
                return false;
            end ;
            return true;
...
function RaidExport:GetMembers()
    return QDKP2raid;
end
    ...
    { header = "Time",
      ...
      query = function(log, Format)
          ...
          if Format == "xml" then
              ...
              return QDKP2_GetDateTextFromTS(ts)
          end
      end,
    },
    { header = "DKP Change",
      ...
      width = 10,
      query = function(log)
          return QDKP2log_GetChange(log) or '';
      end,
    },
    { header = "Description",
...
function QDKP2_BuildHtmlTable(rowList, txtColor, bgColor, borderColor, header, culBord, rowBord)
    ...
    elseif culBord and header then
        borderRule = 'groups'
    elseif culBord then
        borderRule = 'cols'
    elseif rowBord then
